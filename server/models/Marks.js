...
const marksSchema = new mongoose.Schema(
  {
    ...
    mid1: { type: Number, default: 0, min: 0, max: 100 },
    mid2: { type: Number, default: 0, min: 0, max: 100 },
    assignment: { type: Number, default: 0, min: 0, max: 100 },
    lab: { type: Number, default: 0, min: 0, max: 100 },
    internal1: { type: Number, default: 0 },
    internal2: { type: Number, default: 0 },
    final: { type: Number, default: 0, index: true },
